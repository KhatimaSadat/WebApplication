...
const Downloading = ({ t }, props) => {
  ...
  const path =
    "https://larkhoad.s3.ap-south-1.amazonaws.com/school_subjects/dari_curriculam/primary/second_grade/dari_subject/pdf_book/G2-Dr-Dari_compressed.pdf";
  ...
  return (
    <div className="d-section">
      <div className="download-b">
        <Link to="/Book">
          <img className="flesh-image-grade-d" src={image10} />
        </Link>
        <div>
